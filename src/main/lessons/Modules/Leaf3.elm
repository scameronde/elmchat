module Modules.Leaf3 exposing (Msg(Send, Receive), Model, init, update, view, subscriptions)
...
view model =
    div []
        [ h2 [] [ text ("Leaf 3: " ++ model.messageForTitle) ]
        , Html.form [ onSubmit (Send model.messageToSend) ]
            [ div []
                [ label [] [ text "Received: " ]
